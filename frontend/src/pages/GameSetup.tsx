...
export default function GameSetup() {
  ...
  const handleStart = () => {
    if (playerSetId && opponentSetId) {
      ...
      navigate(`/game/play?playerSet=${playerSetId}&opponentSet=${opponentSetId}&playerColor=${actualPlayerColor}&time=${encodeURIComponent(timeControl)}&size=${boardSize}&elo=${aiElo}`);
    }
  };
